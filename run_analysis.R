...
url_features <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\features.txt"
...
url_train_data <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\train\\x_train.txt"
...
url_labels_train_data <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\train\\y_train.txt"
labels_train_data <- read.table(url_labels_train_data, col.names = "labels")
str(labels_train_data)

# Read a subject training data file
url_subject_train_data <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\train\\subject_train.txt"
...
# extract only the measurements based on the mean and standard deviation for each measurement and 
# label the data set appropriately with descriptive variable names
url_test_data <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\test\\x_test.txt"
...
url_labels_test_data <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\test\\y_test.txt"
labels_test_data <- read.table(url_labels_test_data, col.names = "labels")
str(labels_test_data)

# Read a subject testing data file
url_subject_test_data <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\test\\subject_test.txt"
...
url_activity_labels <- "C:\\Users\\abdallah\\Documents\\PGDUZ\\UCI HAR Dataset\\activity_labels.txt"
